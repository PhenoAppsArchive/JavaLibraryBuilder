...
@javax.annotation.Generated(value = "io.swagger.codegen.v3.generators.java.JavaClientCodegen", date = "2018-11-15T17:05:32.234Z[GMT]")public class TraitSummary {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return java.util.Objects.hash(defaultValue, description, name, observationVariables, traitDbId, traitId, traitName);
  }
