...
@javax.annotation.Generated(value = "io.swagger.codegen.v3.generators.java.JavaClientCodegen", date = "2018-11-15T17:05:32.234Z[GMT]")public class Observation {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return java.util.Objects.hash(germplasmDbId, germplasmName, observationDbId, observationLevel, observationTimeStamp, observationUnitDbId, observationUnitName, observationVariableDbId, observationVariableName, operator, season, studyDbId, uploadedBy, value);
  }
