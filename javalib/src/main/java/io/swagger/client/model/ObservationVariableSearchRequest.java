...
@javax.annotation.Generated(value = "io.swagger.codegen.v3.generators.java.JavaClientCodegen", date = "2018-11-15T17:05:32.234Z[GMT]")public class ObservationVariableSearchRequest {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return java.util.Objects.hash(dataTypes, methodDbIds, observationVariableDbIds, observationVariableNames, observationVariableXrefs, ontologyDbIds, page, pageSize, scaleDbIds, scaleXrefs, traitClasses, traitDbIds, traitXrefs);
  }
