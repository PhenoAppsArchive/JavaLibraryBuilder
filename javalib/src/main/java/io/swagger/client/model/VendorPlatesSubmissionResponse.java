...
@javax.annotation.Generated(value = "io.swagger.codegen.v3.generators.java.JavaClientCodegen", date = "2018-11-15T17:05:32.234Z[GMT]")public class VendorPlatesSubmissionResponse {
  ...
  * @return submissionId
  **/
  @Schema(description = "A unique, alpha-numeric ID which identifies a set of plates which have been successfully submitted.")
