...
@javax.annotation.Generated(value = "io.swagger.codegen.v3.generators.java.JavaClientCodegen", date = "2018-11-15T17:05:32.234Z[GMT]")public class ObservationUnitXref {
  ...
  * @return id
  **/
  @Schema(description = "The unique ID in the external reference 'source' system")
  public String getId() {
    return id;
  }
  ...
  * @return source
  **/
  @Schema(description = "The system identifier (name, URL, etc) which has an external reference to the observation unit")
  ...
  @Override
  public int hashCode() {
    return java.util.Objects.hash(id, source);
  }
