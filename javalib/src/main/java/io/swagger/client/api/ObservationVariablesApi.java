...
public class ObservationVariablesApi {
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ObservationVariablesResponse variablesSearchPost(ObservationVariableSearchRequestDep body) throws ApiException {
        ApiResponse<ObservationVariablesResponse> resp = variablesSearchPostWithHttpInfo(body);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<ObservationVariablesResponse> variablesSearchPostWithHttpInfo(ObservationVariableSearchRequestDep body) throws ApiException {
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call variablesSearchPostAsync(ObservationVariableSearchRequestDep body, final ApiCallback<ObservationVariablesResponse> callback) throws ApiException {
