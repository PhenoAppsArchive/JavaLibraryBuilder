        ...
        GsonFireBuilder fireBuilder = new GsonFireBuilder()
          .registerTypeSelector(ListSummary.class, new TypeSelector<ListSummary>() {
            ...
            public Class<? extends ListSummary> getClassForElement(JsonElement readElement) {
                Map<String, Class<? extends ListSummary>> classByDiscriminatorValue = new HashMap<>();

                    classByDiscriminatorValue.put("listDetails".toUpperCase(), ListDetails.class);
                    classByDiscriminatorValue.put("ListSummary".toUpperCase(), ListSummary.class);
