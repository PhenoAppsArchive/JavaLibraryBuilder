...
public class MainActivity extends androidx.appcompat.app.AppCompatActivity
{
    ...
    private void makeButtonReflectCurrentButtonState()
    {
        ...
        {
            case org.wheatgenetics.javalibrarybuilder.MainActivity.MIN_BUTTON_STATE:
            ...
            case org.wheatgenetics.javalibrarybuilder.MainActivity.MAX_BUTTON_STATE:
    ...
    @java.lang.Override protected void onCreate(final android.os.Bundle savedInstanceState)
    {
...

        {
            final android.widget.TextView adjustTextView = this.findViewById(
                org.wheatgenetics.javalibrarybuilder.R.id.adjustTextView);
        ...
        this.internalPermissionDir =
            new org.wheatgenetics.javalibrarybuilder.MainActivity.PermissionDir(this.getFilesDir());
        this.externalPrivatePermissionDir =
            new org.wheatgenetics.javalibrarybuilder.MainActivity.PermissionDir(
        ...
        if (null != savedInstanceState)
        {
            ...
            org.wheatgenetics.javalibrarybuilder.MainActivity.MULTI_LINE_TEXT_VIEW_TEXT_KEY))
                this.setMultiLineTextViewText(savedInstanceState.getCharSequence(org.wheatgenetics
                    .javalibrarybuilder.MainActivity.MULTI_LINE_TEXT_VIEW_TEXT_KEY));
        }
    }
    ...
    public void onButtonClick(@java.lang.SuppressWarnings({"unused"}) final android.view.View view)
    {
        switch (this.buttonState)
        {
            ...
            case 12: case org.wheatgenetics.javalibrarybuilder.MainActivity.MAX_BUTTON_STATE:
        ...
        switch (this.buttonState)
        {
            ...
            default: this.buttonState =
                org.wheatgenetics.javalibrarybuilder.MainActivity.MIN_BUTTON_STATE; break;
        }
        this.makeButtonReflectCurrentButtonState();
    }
}